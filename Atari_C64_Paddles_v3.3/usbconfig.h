...
#define  USB_CFG_VENDOR_ID       0x10, 0x08
 ...
 */
#define  USB_CFG_DEVICE_ID       0x01, 0xe5
 ...
 */
#ifdef Atari
#define USB_CFG_DEVICE_NAME     'A', 't', 'a', 'r', 'i', ' ', 'P', 'a', 'd', 'd', 'l', 'e', 's', ' ', 'v', '3', '.', '3'
#define USB_CFG_DEVICE_NAME_LEN 18
#else //Commodore
#define USB_CFG_DEVICE_NAME     'C', '6', '4', ' ', 'P', 'a', 'd', 'd', 'l', 'e', 's', ' ', 'v', '3', '.', '3'
